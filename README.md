...
- `src/game/PhaserGame.jsx` - The React component that initializes the Phaser GameScene and serve like a bridge between React and Phaser.
...
class MyScene extends Phaser.Scene
{
    ...
    create ()
    {
        // Your GameScene Objects and logic here
...
In the code above, you can get a reference to the current Phaser GameScene instance and the current Scene by creating a reference with `useRef()` and assign to PhaserGame component.
